...
class BWP_MINIFY extends BWP_FRAMEWORK {
	 ...
	 */
	var $print_positions = array('header' => array(), 'footer' => array(), 'direct' => array(), 'ignore' => array(), 'ignore_def' => array());
	 ...
	 * Constructor
	 */	
	function __construct($version = '1.3.6')
	{
		// Plugin's title
...
{	
	...
	{
		$form = array(
			'items'			=> array('heading', 'checkbox', 'checkbox', 'checkbox', 'checkbox', 'heading', 'input', 'input', 'input', 'select', 'heading', 'textarea', 'textarea', 'textarea', 'textarea', 'textarea'),
			'item_labels'	=> array
			(
				__('General Options', 'bwp-minify'),
				__('Minify JS files automatically?', 'bwp-minify'),
				__('<strong>[BETA]</strong> Deferring js automatically?', 'bwp-minify'),
				...
				__('Scripts to not deferred (not asynchrone)', 'bwp-minify')
			),
			'item_names'	=> array('h1', 'cb1', 'cb4', 'cb3', 'cb2', 'h2', 'input_minurl', 'input_cache_dir', 'input_maxfiles', 'select_buster_type', 'h3', 'input_header', 'input_footer', 'input_direct', 'input_ignore', 'input_ignore_def'),
			'heading'			=> array(
				'h1'	=> '',
			...
			'checkbox'	=> array(
				...
				'cb4' => array(__('Activate the deferred capabilities. <em>functionality inspired from the plugin : <a href="http://wordpress.org/plugins/wp-deferred-javascripts/" title="WP Deferred" target="_blank">WP Deferred</a></em>', 'bwp-minify') => 'enable_deferring'),
			...
			(
				...
				'input_ignore_def' => array('cols' => 40, 'rows' => 3)
			),
			'container'	=> array(
		...
		$options = $bwp_option_page->get_options(array('input_minurl', 'input_cache_dir', 'input_maxfiles', 'input_header', 'input_footer', 'input_direct', 'input_ignore', 'input_ignore_def', 'input_custom_buster', 'select_buster_type', 'enable_min_js', 'enable_deferring', 'enable_min_css', 'enable_bloginfo'), $this->options);
...
<?php
	...
	function parse_positions()
	{
		$positions = array(
			...
			'ignore_def'	=> $this->options['input_ignore_def']
		);
